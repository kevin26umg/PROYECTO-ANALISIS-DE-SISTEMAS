...
$query = "SELECT codigo, codigo_alterno, producto, presentacion, preciocosto, existencia, proveedor from inventario where producto like :buscar OR codigo like :buscar OR proveedor like :buscar limit 45";
