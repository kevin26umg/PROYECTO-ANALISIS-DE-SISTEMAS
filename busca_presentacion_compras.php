...
$query = "Select * from presentaciones where codigo= :buscar";
...
if($bus){
    ...
    echo '<td style="text-align:center;">'.$gt['tipo_precio']."</td>";
    ...
    $varproductos=$gt['codigo']."|".$gt['tipo_precio']."|".$gt['presentacion']."|".$gt['unidades']."|".$gt['precio'];
