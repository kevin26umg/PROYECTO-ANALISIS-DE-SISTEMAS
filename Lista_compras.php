    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small> Lista de Compras | Usuario: <?php echo $_SESSION['nombre_de_usuario']; ?> | </small>
...
<br> 
    ...
    <script src="dist/js/source_lista_compras.js"></script>
...
function modificar_comprax (id){
  var alimentos=id;
  var idcl=alimentos.split("|");
  factura=idcl[0];
  proveedor=idcl[1];

window.location.href = "Compras2.php?id="+factura+"&proveedor="+proveedor;
