...
$set_names=$db->query("SET NAMES 'utf8'");
    ...
    $query = "Select DISTINCT categoria from inventario order by categoria asc";
...
echo '<option disabled selected value="">Seleccione una categoría</option>';
	...
	foreach ($resultado as $key =>$re){    
	    ...
	    {
echo ' <option value="'.$re['categoria'].'">'.$re['categoria'].'</option>';	        
	    }
