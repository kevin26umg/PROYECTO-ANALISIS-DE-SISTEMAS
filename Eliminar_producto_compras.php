...
$revisainventarioa = "Select * from detalle_compras where id= :idddae";
...
$update = "delete from detalle_compras where id= :buscar";
...
$revisainventario = "Select * from inventario where codigo_alterno= :iddda";
