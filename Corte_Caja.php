...
<br>
           ...
           <button class='btn btn-primary pull-left' onclick='cortex();'><i class='fa fa-search'></i> Consultar Efectivo</button>
...
var id=$("#ff").val();
var idfi=$("#fi").val();
window.open("corte_de_caja.php?varf="+encodeURIComponent(id)+' &vari=' + encodeURIComponent(idfi));
}
/*******************************************************************************************/
 </script>   
  </body>
