      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Comisión Ventas</li>
          </ol>
        </section>
...
//                      include "./class_lib/class_conecta_mysql.php";
            ...
            ?>
       <div class='form-group'>
                  <label for="encargado" class="col-sm-4 control-label">Usuario</label> 
                    <div class="col-sm-9">
                    <div>
                      <select name="linea" id="usuario" class="form-control">
                        <?php 
                          $selectLinea=$cons->prepare("SELECT * FROM usuarios order by Usuario asc");
                          $selectLinea->execute();
                          foreach($selectLinea as $key =>$rowLineas){      
                             echo '<option value="'.$rowLineas['Usuario'].'">'.$rowLineas['Usuario'].'</option>';
                          }
                        ?>
                      </select>
...
window.open("Comisiones_vendedor.php?varf="+encodeURIComponent(id)+' &vari=' + encodeURIComponent(idfi)+' &usuario=' + encodeURIComponent(usuario));
}
/*****************************************************************************/
  </script>   
