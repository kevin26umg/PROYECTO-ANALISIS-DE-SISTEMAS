...
function vencidos(){
  $.ajax({
         beforeSend: function(){
           $("#gastos_registrados").html("Actualizando la lista...");
          },
         url: 'Inventario_agotados_imprimir.php',
         type: 'POST',
         data: 'fechai='+$("#fi").val()+'&fechaf='+$("#ff").val(),
         success: function(y){
           $("#gastos_registrados").html(y);
		   botones();
           $(document).ready(function() {
...
function agotados(){
        $.ajax({
         ...
         url: 'Inventario_existencias_mostrar.php',
         type: 'POST',
         data: 'fechai='+$("#fi").val()+'&fechaf='+$("#ff").val(),
         success: function(y){
...
function mostrar_datos(){
        $.ajax({
         ...
         url: 'Inventario_existencias_imprimir.php',
         type: 'POST',
         data: 'fechai='+$("#fi").val()+'&fechaf='+$("#ff").val(),
         success: function(y){
           $("#gastos_registrados").html(y);
...
/**********************************************************************************/
function mostrar_datos_general(){
        $.ajax({
         beforeSend: function(){
           $("#gastos_registrados").html("Actualizando la lista...");
          },
         url: 'Inventario_general_imprimir.php',
         type: 'POST',
         data: 'fechai='+$("#fi").val()+'&fechaf='+$("#ff").val(),
         success: function(y){
           $("#gastos_registrados").html(y);
