...
function busca_articulo(){
          ...
          success: function(x){
            ...
            $('#codigo').focus();
	         ...
	         $("#descripcion").val(x.producto);
             $("#costo").val(x.preciocosto);
                    ...
                    {addClass: 'btn btn-primary',
                     ...
                     onClick : function ($noty){
                          ...
                          $('#tabla_articulos > tbody > tr').each(function(){
                             ...
                             '&proveedor='+$("#proveedor").val()+'&idp='+$("#idp").val()+
                             '&tipo='+$("#tipo").val()+'&num_entrada='+$("#num_entrada2").val()+
                             '&num_fact='+$("#factura").val()+'&serie='+$("#serie").val()+
