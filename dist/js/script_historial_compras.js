...
function trae_venta(){
  $(document).ready(function(){
    ...
    $.ajax({
          beforeSend: function(){
            $("#data1").html("Buscando ventas, un momento...");
           },
...
function busca_gastos(){
  $(document).ready(function (){
    if($("#fi").val()!=""||$("#ff").val()!=""){
       $.ajax({
            beforeSend: function(){
             $("#data").html("Buscando registro de compras, un momento...");
             },
            url: 'busca_historial_compras.php',
            type: 'POST',
   ...
   $("#modal_detalle_gasto").modal({
                      ...
                      keyboard: false
                       ...
                       $.ajax({
                          ...
                          url: 'consulta_detalle_ventas.php',
                          type: 'POST',
                          data: 'id_gasto='+num_,
                          success: function(x){
