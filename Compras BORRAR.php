    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small> Detalle de Compras | Usuario: <?php echo $_SESSION['nombre_de_usuario']; ?> | </small>
...
<!--<div class="contenido col">
          ...
          <input type='text' id='factura' class='form-control' placeholder='' onchange='busca_datos_pedidos();' style="font-size:16px; text-align:center; color:blue; font-weight: bold;">
          </div>
          </div>
          </div>
