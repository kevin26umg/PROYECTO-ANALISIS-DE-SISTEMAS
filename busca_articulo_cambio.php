...
$query = "select codigo, producto, presentacion, existencia, minima, preciocosto, preciod, precioc, preciob, precioa from inventario where codigo= :cod";
...
if(!isset($rows[0]->codigo)){
   ...
   // while($re=$db->buscar_array($exe)){
      $resultado->bindParam(":cod",$codigo);	
      $resultado->execute();	
